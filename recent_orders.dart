          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: [
                  _orderRow('JO-2044401', 'ABC Corporation', 'banner_printing', 'Jul 17, 2025', 'Completed', '₱8,500', '1'),
                  _orderRow('JO-701050', 'ABC Corporation', 'tarpaulin_printing', 'Jul 17, 2025', 'Completed', '₱1,200', '1'),
                  _orderRow('JO-799910', 'ABC Corporation', 'photo_printing', 'Jul 17, 2025', 'In Progress', '₱750', '2'),
                  _orderRow('JO-199382', 'ABC Corporation', 'banner_printing', 'Jul 17, 2025', 'In Progress', '₱2,800', '1'),
                  _orderRow('JO-298527', 'ABC Corporation', 'business_cards', 'Jul 17, 2025', 'Pending', '₱1,500', '2'),
                  _orderRow('JO-461239', 'ABC Corporation', 'sticker_printing', 'Jul 17, 2025', 'Pending', '₱6,000', '2'),
                  _orderRow('JO-519447', 'ABC Corporation', 'large_format_printing', 'Jul 17, 2025', 'Delayed', '₱3,600', '1'),
                  _orderRow('JO-552838', 'ABC Corporation', 'flyer_printing', 'Jul 17, 2025', 'Cancelled', '₱2,500', '1'),
                ],
              ),
            ),
          ],
    ...
    return DataRow(cells: [
      ...
      DataCell(Column(
        ...
        children: [
          ...
          Text('ID: $createdBy', style: const TextStyle(fontSize: 12, color: Colors.grey)),
        ],
      )),
                ...
                child: DataTable(
                  ...
                  rows: [
                    DataRow(cells: [
                      ...
                      DataCell(Container()), // Actions placeholder
                    ]),
                    DataRow(cells: [
